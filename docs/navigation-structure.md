...
To add auxiliary links to your site (in the upper right on all pages), add it to the `aux_links` [configuration option](local-multiplayer-ar.github.io/{% link docs/configuration.md %}#aux-links) in your site's `_config.yml` file.
